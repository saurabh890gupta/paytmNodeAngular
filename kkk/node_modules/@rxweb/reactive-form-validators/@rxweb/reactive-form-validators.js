...
const defaultContainer = new (class {
     ...
     * @return {?}
     */
    getActionContainer(target, keyName) {
        let /** @type {?} */ actionContainer = this.actions.filter(action => action.instance == target)[0];
        if (actionContainer)
...
class ReactiveFormConfig {
     ...
     * @return {?}
     */
    static setActiveUiFramework(name) {
...
class RxFormControl extends FormControl {
     ...
     */
    constructor(formState, validator, asyncValidator, entityObject, baseObject, controlName, _sanitizers, _formControlConfig) {
    ...
    setValue(value, options) {
        if (this.preHook && (!options || (options && !options.isThroughDynamic))) {
            ...
            if (!isPassed) {
                ...
                let /** @type {?} */ patch = { isThroughDynamic: true };
...
class FormControlConfig {
     ...
     * @return {?}
     */
    onAttributeValueChange(names, func) {
...
const DynamicReactiveFormConfig = new (class {
    constructor() {
...
const VALUE = "value";
const CONTROL_TEMPLATES = "controlTemplates";
const PREPEND_TEXTBOX = "prependTextbox";
...
class RxWebControlComponent {
        ...
        if (this.formControlConfig && this.formControlConfig.events) {
            ...
            for (var /** @type {?} */ columnName in this.formControlConfig.events) {
                if (instance[columnName] instanceof EventEmitter) {
                    let /** @type {?} */ observe = ( /** @type {?} */(instance[columnName])).asObservable();
     ...
     * @return {?}
     */
    addParams(instance, propName, inputs) {
...
class ControlTemplateDirective {
    /**
     * @param {?} templateRef
     */
...
class RxwebActionDirective {
     ...
     * @return {?}
     */
    setDefaultCssClass(controlName) {
        var /** @type {?} */ classes = [];
        switch (controlName) {
            case 'radio':
            case 'checkbox':
     ...
     * @return {?}
     */
    process(name, value, element = null) {
        switch (name) {
            case 'focus':
                if (value)
     ...
     * @return {?}
     */
    setOrUpdateAttribute(attributeName, value) {
...
class RxwebErrorMessageDirective {
    /**
     * @param {?} renderer
     * @param {?} elementRef
     */
...
class RxDynamicReactiveFormsModule {
    /**
     * @return {?}
     */
    static forRoot() { return { ngModule: RxDynamicReactiveFormsModule, providers: [] }; }
}
...
class DynamicFormBuilder {
     ...
     */
    constructor(validatorBindings, formConfiguration) {
     ...
     * @return {?}
     */
    dynamicFormGroup(fields, formConfiguration) {
...
class RxFormBuilder extends BaseFormBuilder {
     ...
     * @return {?}
     */
    dynamicForm(fields, formConfiguration) {
