...
var defaultContainer = new (/** @class */ (function () {
     ...
     * @return {?}
     */
    class_1.prototype.initAction = function (target, configs) {
        var /** @type {?} */ actionContainer = this.actions.filter(function (action) { return action.instance == target; })[0];
        if (!actionContainer)
     ...
     * @return {?}
     */
    class_1.prototype.getActionContainer = function (target, keyName) {
        var /** @type {?} */ actionContainer = this.actions.filter(function (action) { return action.instance == target; })[0];
        if (actionContainer)
            return actionContainer.configs.filter(function (t) { return t.keyName == keyName; })[0];
        return undefined;
    };
    /**
     * @param {?} target
...
var ReactiveFormConfig = /** @class */ (function () {
     ...
     * @return {?}
     */
    ReactiveFormConfig.setActiveUiFramework = function (name) {
...
function conditionalChangeValidator(conditionalValidationProps) {
    ...
    return function (control) {
        ...
        if (control.parent && oldValue != value) {
            var /** @type {?} */ parentFormGroup_1 = ApplicationUtil.getRootFormGroup(control);
            oldValue = value;
            conditionalValidationProps.forEach(function (t) {
                if (t.indexOf("[]") != -1) {
                    var /** @type {?} */ splitText = t.split("[]");
                    var /** @type {?} */ formArray = /** @type {?} */ (parentFormGroup_1.get([splitText[0]]));
                    if (formArray)
                    ...
                    t.split('.').forEach(function (name, index) { control = (index == 0) ? parentFormGroup_1.controls[name] : control.controls[name]; });
                    if (control) {
                        setTimeOut(control);
                    }
                }
...
var RxFormControl = /** @class */ (function (_super) {
     ...
     */
    function RxFormControl(formState, validator, asyncValidator, entityObject, baseObject, controlName, _sanitizers, _formControlConfig) {
        ...
        _this._baseValue = formState === undefined ? null : formState;
        _this._isModified = false;
        ...
        _this.controlConfig = _formControlConfig;
        if (_this.controlConfig && _this.controlConfig.hooks) {
            if (_this.controlConfig.hooks.preValue)
                _this.preHook = _this.controlConfig.hooks.preValue;
            if (_this.controlConfig.hooks.postValue)
                _this.postHook = _this.controlConfig.hooks.postValue;
        }
        return _this;
    }
    ...
    RxFormControl.prototype.setValue = function (value, options) {
        if (this.preHook && (!options || (options && !options.isThroughDynamic))) {
            var /** @type {?} */ isPassed = this.preHook.call(this.controlConfig);
            if (!isPassed) {
                var /** @type {?} */ previousValue = this.value;
                var /** @type {?} */ patch = { isThroughDynamic: true };
                _super.prototype.patchValue.call(this, previousValue, patch);
            }
        }
        else {
...
var RxFormGroup = /** @class */ (function (_super) {
    ...
    RxFormGroup.prototype.valueChangedSync = function () {
        var _this = this;
        Object.keys(this.controls).forEach(function (columnName) {
            if (!(_this.controls[columnName] instanceof forms.FormArray || _this.controls[columnName] instanceof RxFormArray) && !(_this.controls[columnName] instanceof forms.FormGroup || _this.controls[columnName] instanceof RxFormGroup) && !(_this.entityObject[columnName] instanceof forms.FormControl || _this.entityObject[columnName] instanceof RxFormControl) && ApplicationUtil.notEqualTo(( /** @type {?} */(_this.controls[columnName])).getControlValue(), _this.entityObject[columnName])) {
...
function configProvider(control, config, configName) {
    if (config.dynamicConfig) {
        var /** @type {?} */ currentConfig = FormProvider.ProcessRule(control, clone(config), true);
 ...
 * @abstract
 */
var FormControlConfig = /** @class */ (function () {
    /**
     * @param {?} fieldConfig
     ...
     * @return {?}
     */
    FormControlConfig.prototype.onAttributeValueChange = function (names, func) {
    ...
    Object.defineProperty(FormControlConfig.prototype, "source", {
        /**
         * @return {?}
         */
        get: function () {
        ...
        set: function (value) {
            ...
            if (Array.isArray(value))
                ...
                (value.then(function (x) { return _this._source = x; }));
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(FormControlConfig.prototype, "value", {
        /**
         * @return {?}
         */
        get: function () {
    ...
    Object.defineProperty(FormControlConfig.prototype, "disable", {
        /**
         * @return {?}
         */
        get: function () {
    ...
    Object.defineProperty(FormControlConfig.prototype, "label", {
        /**
         * @return {?}
         */
        get: function () {
    ...
    Object.defineProperty(FormControlConfig.prototype, "placeholder", {
        /**
         * @return {?}
         */
        get: function () {
    ...
    Object.defineProperty(FormControlConfig.prototype, "hide", {
        /**
         * @return {?}
         */
        get: function () {
    ...
    Object.defineProperty(FormControlConfig.prototype, "description", {
        /**
         * @return {?}
         */
        get: function () {
    ...
    Object.defineProperty(FormControlConfig.prototype, "focus", {
        /**
         * @return {?}
         */
        get: function () {
    ...
    Object.defineProperty(FormControlConfig.prototype, "readonly", {
        /**
         * @return {?}
         */
        get: function () {
    ...
    Object.defineProperty(FormControlConfig.prototype, "cssClassNames", {
        /**
         * @return {?}
         */
        get: function () {
    ...
    Object.defineProperty(FormControlConfig.prototype, "isPlainTextMode", {
        /**
         * @return {?}
         */
        get: function () {
     ...
     * @return {?}
     */
    FormControlConfig.prototype.complete = function () {
        for (var /** @type {?} */ action_1 in this.controlNotifications)
            for (var /** @type {?} */ columnName in this.controlsConfig) {
                if (!Array.isArray(this.controlsConfig[columnName]) && this.controlsConfig[columnName].actions[action_1]) {
                    var /** @type {?} */ stringFunction = String(this.controlsConfig[columnName].actions[action_1]);
                    if (stringFunction.indexOf("." + this.config.name) != -1 || stringFunction.indexOf("." + this.config.name + ";") != -1) {
                        this.controlNotifications[action_1].push(columnName);
                    }
                }
            }
     ...
     * @return {?}
     */
    FormControlConfig.prototype.refresh = function (actionName) {
        var _this = this;
            ...
            if (this.controlNotifications[columnName].length > 0)
                this.controlNotifications[columnName].forEach(function (x) {
                    if (x != _this.config.name)
                        _this.controlsConfig[x].refresh(columnName);
                    else
     ...
     * @return {?}
     */
    FormControlConfig.prototype.notifyAttributeValueChange = function (name, value) {
        if (this.isNotEqual(this._actionResult[name], value) && this.onAttributeValueChange) {
            ...
            subscriptions.forEach(function (subscribe) { return subscribe.func(name, value); });
        }
    };
    /**
     * @param {?} leftValue
     ...
     * @return {?}
     */
    FormControlConfig.prototype.isNotEqual = function (leftValue, rightValue) {
        if (Array.isArray(leftValue) && Array.isArray(rightValue)) {
            var /** @type {?} */ isEqual = leftValue.length == rightValue.length;
            if (isEqual)
     ...
     * @return {?}
     */
    FormControlConfig.prototype.setActionValue = function (actionName) {
     ...
     * @return {?}
     */
    FormControlConfig.prototype.updateActionValue = function () {
        var _this = this;
        Object.keys(this.controlNotifications).forEach(function (key) {
            if (_this.actions[key])
                _this[key == FILTER ? SOURCE : key] = _this.actions[key].call(_this);
            else if (_this.config.ui && _this.config.ui[key])
                _this[key == FILTER ? SOURCE : key] = _this.config.ui[key];
        });
    };
    /**
     * @return {?}
     */
    FormControlConfig.prototype.setNotifications = function () {
        var _this = this;
        ...
        if (this.config.controlNotifications)
            for (var /** @type {?} */ columnName in this.controlNotifications)
                if (this.config.controlNotifications[columnName])
                    this.config.controlNotifications[columnName].forEach(function (x) { return _this.controlNotifications[columnName].push(x); });
    };
    /**
     * @return {?}
     */
    FormControlConfig.prototype.setActions = function () {
        var _this = this;
        this.actions = {};
        this.hooks = {};
        if (this.config.actionKeyNames) {
            this.config.actionKeyNames.forEach(function (actionKey) {
                var /** @type {?} */ action = defaultContainer.getActionContainer(_this.constructor, actionKey);
                if (action) {
                    if (action.actions) {
                        Object.keys(action.actions).forEach(function (key) {
                            if (action.actions[key])
                                _this.actions[key] = action.actions[key];
                        });
                    }
                    if (action.hooks) {
                        Object.keys(action.hooks).forEach(function (key) {
                            if (action.hooks[key])
                                _this.hooks[key] = action.hooks[key];
                        });
                    }
                    if (action.validator)
                        _this.validator = action.validator();
                    if (action.asyncValidator)
                        _this.asyncValidator = action.asyncValidator();
                }
            });
        }
    };
...
var DynamicReactiveFormConfig = new (/** @class */ (function () {
    function class_2() {
     ...
     * @return {?}
     */
    class_2.prototype.registerComponent = function (configs) {
        var _this = this;
        var /** @type {?} */ entryComponents = [];
        Object.keys(configs).forEach(function (key) {
            _this.componentConfigs[key] = configs[key];
            entryComponents.push(_this.componentConfigs[key].component);
        });
     ...
     * @return {?}
     */
    class_2.prototype.removeComponent = function (typeNames) {
        var _this = this;
        typeNames.forEach(function (name) { return delete _this.componentConfigs[name]; });
    };
    /**
     * @param {?} typeName
     * @return {?}
     */
    class_2.prototype.getComponentConfig = function (typeName) {
        var /** @type {?} */ componentConfig = this.componentConfigs[typeName];
        return componentConfig;
    };
    return class_2;
}()));
var CONTROL_CONTAINER = "controlContainer";
var SECTION_CONFIG = "sectionConfig";
var FORM_CONTROL = "formControl";
var CONTROL_CONFIG = "controlConfig";
var VALUE = "value";
var CONTROL_TEMPLATES = "controlTemplates";
var PREPEND_TEXTBOX = "prependTextbox";
var TEXTBOX = "textbox";
var CONTROLS_CONFIG = "controlsConfig";
var RxWebControlComponent = /** @class */ (function () {
    /**
     * @param {?} componentFactoryResolver
     */
    function RxWebControlComponent(componentFactoryResolver) {
        var _this = this;
        this.componentFactoryResolver = componentFactoryResolver;
        this.isCleared = false;
        this.onHide = function () {
            if (_this.formControlConfig.hide) {
                _this.clear();
            }
            else if (!_this.componentRef) {
                _this.createInstance();
            }
        };
    }
    Object.defineProperty(RxWebControlComponent.prototype, "viewMode", {
        /**
         * @return {?}
         */
        get: function () {
     ...
     * @return {?}
     */
    RxWebControlComponent.prototype.ngOnInit = function () {
        this.process();
    };
    /**
     * @return {?}
     */
    RxWebControlComponent.prototype.process = function () {
        if (this.formControlConfig || this.sectionConfig) {
            var /** @type {?} */ name_1 = this.getName();
            this.componentConfig = DynamicReactiveFormConfig.getComponentConfig(name_1);
            if (!this.componentConfig && this.controlTemplates.length > 0) {
                var /** @type {?} */ controlTemplate = this.controlTemplates.filter(function (t) { return t.type == name_1; })[0];
                var /** @type {?} */ jObject = {};
     ...
     * @return {?}
     */
    RxWebControlComponent.prototype.getName = function () {
        var /** @type {?} */ name = this.formControlConfig ? this.formControlConfig.config.type : this.sectionConfig ? this.sectionConfig.sectionName : undefined;
     ...
     * @return {?}
     */
    RxWebControlComponent.prototype.createInstance = function () {
     ...
     * @return {?}
     */
    RxWebControlComponent.prototype.subscribeEvents = function (instance) {
        var _this = this;
        if (this.formControlConfig && this.formControlConfig.events) {
            ...
            for (var /** @type {?} */ columnName in this.formControlConfig.events) {
                if (instance[columnName] instanceof core.EventEmitter) {
                    var /** @type {?} */ observe = ( /** @type {?} */(instance[columnName])).asObservable();
                    this.eventSubscriptions.push(observe.subscribe(function (t) { _this.formControlConfig.events[columnName].call(_this.formControlConfig, t); }));
                }
            }
        }
    };
     ...
     * @return {?}
     */
    RxWebControlComponent.prototype.setSectionConfigParams = function () {
     ...
     * @return {?}
     */
    RxWebControlComponent.prototype.setFieldConfigParams = function (instance) {
        for (var /** @type {?} */ param in this.formControlConfig.inputs)
     ...
     * @return {?}
     */
    RxWebControlComponent.prototype.overrideValueProp = function () {
        var _this = this;
        if (!this.formControlConfig.override) {
            var /** @type {?} */ descriptor_1 = Object.getOwnPropertyDescriptor(Object.getPrototypeOf(this.formControlConfig), VALUE);
            Object.defineProperty(this.formControlConfig, VALUE, {
                get: function () { return descriptor_1.get.call(_this.formControlConfig); },
                set: function (v) {
                    if (_this.formControlConfig.formControl.value != v) {
                        _this.formControlConfig.formControl.setValue(v);
                    }
                    else {
                        descriptor_1.set.call(_this.formControlConfig, v);
                        _this.formControlConfig.refresh();
                    }
                    _this.formControlConfig.config.value = v;
                }
            });
     ...
     * @return {?}
     */
    RxWebControlComponent.prototype.clear = function () {
     ...
     * @return {?}
     */
    RxWebControlComponent.prototype.addParams = function (instance, propName, inputs) {
        var /** @type {?} */ descriptor = Object.getOwnPropertyDescriptor(Object.getPrototypeOf(inputs), propName);
        var /** @type {?} */ value = '';
        if (!descriptor) {
     ...
     * @return {?}
     */
    RxWebControlComponent.prototype.ngOnDestroy = function () {
        if (this.eventSubscriptions)
            this.eventSubscriptions.forEach(function (t) { return t.unsubscribe(); });
...
RxWebControlComponent.propDecorators = {
    'controlContainerRef': [{ type: core.ViewChild, args: [CONTROL_CONTAINER, { read: core.ViewContainerRef },] },],
    'formControlConfig': [{ type: core.Input },],
    'sectionConfig': [{ type: core.Input },],
    'viewMode': [{ type: core.Input },],
    'name': [{ type: core.Input },],
    'formGroup': [{ type: core.Input },],
    'formArray': [{ type: core.Input },],
    'controlsConfig': [{ type: core.Input },],
...
var RxwebDynamicFormComponent = /** @class */ (function () {
    ...
    Object.defineProperty(RxwebDynamicFormComponent.prototype, "viewMode", {
        /**
         * @return {?}
         */
        get: function () {
    ...
    Object.defineProperty(RxwebDynamicFormComponent.prototype, "controlTemplates", {
        /**
         * @return {?}
         */
        get: function () {
     ...
     * @return {?}
     */
    RxwebDynamicFormComponent.prototype.designRows = function (bindings) {
        var /** @type {?} */ rows = [];
        for (var _i = 0, bindings_1 = bindings; _i < bindings_1.length; _i++) {
            var item = bindings_1[_i];
            var /** @type {?} */ jObject = { cols: [] };
     ...
     * @return {?}
     */
    RxwebDynamicFormComponent.prototype.changeSectionViewMode = function () {
        var _this = this;
        if (this.sectionsConfig) {
            Object.keys(this.sectionsConfig).forEach(function (t) {
                _this.sectionsConfig[t].viewMode = _this.viewMode;
            });
        }
    };
...
RxwebDynamicFormComponent.propDecorators = {
    'sectionsConfig': [{ type: core.Input },],
    'uiFramework': [{ type: core.Input },],
    'viewMode': [{ type: core.Input },],
    'controlsConfig': [{ type: core.Input },],
    'bindings': [{ type: core.Input },],
    'controlTemplates': [{ type: core.Input },],
};
var ControlTemplateDirective = /** @class */ (function () {
    /**
     * @param {?} templateRef
     */
    function ControlTemplateDirective(templateRef) {
        this.templateRef = templateRef;
    }
    
    return ControlTemplateDirective;
}());
 ...
 * @nocollapse
 */
ControlTemplateDirective.ctorParameters = function () { return [
    { type: core.TemplateRef, },
]; };
ControlTemplateDirective.propDecorators = {
    'type': [{ type: core.Input, args: ['controlTemplate',] },],
};
var RxDynamicForm = /** @class */ (function () {
    function RxDynamicForm() {
    }
    /**
     * @return {?}
     */
    RxDynamicForm.prototype.ngAfterContentInit = function () {
        var _this = this;
        if (!this.formGroup)
        ...
        if (this.dynamicFormComponent && this.dynamicFormComponent.length > 0) {
            this.dynamicFormComponent.forEach(function (t) {
                if (t.sectionsConfig) {
                    Object.keys(t.sectionsConfig).forEach(function (x) {
                        var /** @type {?} */ formControl = _this.formGroup && t.sectionsConfig[x].formName ? _this.formGroup.controls[t.sectionsConfig[x].formName] : _this.formGroup;
                        if (formControl instanceof forms.FormGroup) {
                            t.sectionsConfig[x].formGroup = /** @type {?} */ (formControl);
                            t.sectionsConfig[x].controlsConfig = _this.configs.controlsConfig;
                        }
                        else if (formControl instanceof forms.FormArray) {
                            t.sectionsConfig[x].controlsConfig = _this.configs.controlsConfig[t.sectionsConfig[x].formName];
                            t.sectionsConfig[x].formArray = /** @type {?} */ (formControl);
                        }
                    });
                }
                else
                    t.sectionsConfig = {};
                t.controlTemplates = _this.controlTemplates;
            });
        }
    };
    return RxDynamicForm;
}());
 ...
 * @nocollapse
 */
RxDynamicForm.ctorParameters = function () { return []; };
RxDynamicForm.propDecorators = {
    'columnComponents': [{ type: core.ContentChildren, args: [RxWebControlComponent,] },],
    'dynamicFormComponent': [{ type: core.ContentChildren, args: [RxwebDynamicFormComponent,] },],
    'controlTemplates': [{ type: core.ContentChildren, args: [ControlTemplateDirective,] },],
    'configs': [{ type: core.Input, args: ['rxDynamicForm',] },],
    'formGroup': [{ type: core.Input, args: ['formGroup',] },],
};
var RxwebActionDirective = /** @class */ (function () {
    /**
     * @param {?} renderer
     * @param {?} elementRef
     */
    function RxwebActionDirective(renderer, elementRef) {
    ...
    Object.defineProperty(RxwebActionDirective.prototype, "controlConfig", {
        /**
         * @return {?}
         */
        get: function () {
     ...
     * @return {?}
     */
    RxwebActionDirective.prototype.setControlClass = function () {
        var /** @type {?} */ controlName = '';
     ...
     * @return {?}
     */
    RxwebActionDirective.prototype.setDefaultCssClass = function (controlName) {
        var /** @type {?} */ classes = [];
        switch (controlName) {
            case 'radio':
            case 'checkbox':
     ...
     * @return {?}
     */
    RxwebActionDirective.prototype.bindAttributes = function () {
        var _this = this;
        if (this._controlConfig && this.attributeNames && Array.isArray(this.attributeNames)) {
            this.attributeNames.forEach(function (t) {
                if (_this.controlConfig[t])
                    _this.process(t, _this.controlConfig[t]);
                if (_this._cssConfig[t])
                    _this.process('cssClassNames', [_this._cssConfig[t]]);
                if (t == "group") {
                    var /** @type {?} */ classNames = [];
                    switch (_this.controlConfig.viewMode) {
                        ...
                        case "bootstrap-advance":
                            if (_this.controlConfig.config && _this.controlConfig.config.ui && _this.controlConfig.config.ui.formGrid) {
                                var /** @type {?} */ formGrid = _this.controlConfig.config.ui.formGrid;
                                if (formGrid.column) {
                                    var /** @type {?} */ classNames_1 = _this.getCssClasses(formGrid.column);
                                    _this.process('cssClassNames', classNames_1, _this.element.parentElement.parentElement);
                                }
                            }
                            break;
                    }
                }
                if (t == "label" && _this.controlConfig.viewMode == "bootstrap-horizontal" && _this.controlConfig.config && _this.controlConfig.config.ui && _this.controlConfig.config.ui.formGrid) {
                    var /** @type {?} */ formGrid = _this.controlConfig.config.ui.formGrid;
                    var /** @type {?} */ cssClasses = [];
                    if (formGrid.label)
                        cssClasses = _this.getCssClasses(formGrid.label);
                    else
                        cssClasses.push('col-md-2');
                    _this.process('cssClassNames', cssClasses);
                }
                if (!_this.controlConfig[t] && !_this._cssConfig[t]) {
                    var /** @type {?} */ splitText = t.split('.');
                    if (splitText.length > 1) {
                        var /** @type {?} */ jObject_1 = undefined;
                        splitText.forEach(function (x) {
                            if (!jObject_1)
                                jObject_1 = _this.controlConfig.config.ui ? _this.controlConfig.config.ui[x] : undefined;
                            else
                                jObject_1 = jObject_1[x];
                            return jObject_1 != undefined;
                        });
                        var /** @type {?} */ cssClasses = jObject_1 ? _this.getCssClasses(jObject_1) : [];
                        _this.process('cssClassNames', cssClasses);
                    }
                }
            });
     ...
     * @return {?}
     */
    RxwebActionDirective.prototype.getCssClasses = function (jObject) {
        var /** @type {?} */ cssClasses = [];
     ...
     * @return {?}
     */
    RxwebActionDirective.prototype.subscribe = function () {
        var _this = this;
        this._controlConfig.onAttributeValueChange(this.attributeNames, function (name, value) {
            _this.process(name, value);
        });
     ...
     * @return {?}
     */
    RxwebActionDirective.prototype.process = function (name, value, element) {
        var _this = this;
        ...
        switch (name) {
            ...
            case 'cssClassNames':
                if (value.oldClassNames)
                    value.oldClassNames.forEach(function (t) { return _this.renderer.setElementClass(_this.element, t, false); });
                if (value.newClassNames)
                    value.newClassNames.forEach(function (t) { return _this.renderer.setElementClass(_this.element, t, true); });
                if (Array.isArray(value))
                    value.forEach(function (t) { return _this.renderer.setElementClass(element || _this.element, t, true); });
                break;
            default:
                this.setOrUpdateAttribute(name, value);
        }
     ...
     * @return {?}
     */
    RxwebActionDirective.prototype.createText = function (text) {
     ...
     * @return {?}
     */
    RxwebActionDirective.prototype.invokeMethod = function (eventName, values) {
        this.renderer.invokeElementMethod(this.element, eventName, values);
    };
    /**
     * @param {?} attributeName
     * @param {?} value
     * @return {?}
     */
    RxwebActionDirective.prototype.setOrUpdateAttribute = function (attributeName, value) {
 ...
 * @nocollapse
 */
RxwebActionDirective.ctorParameters = function () { return [
    { type: core.Renderer, },
    { type: core.ElementRef, },
]; };
RxwebActionDirective.propDecorators = {
    'hideIfNoValue': [{ type: core.Input },],
    'attributeNames': [{ type: core.Input, args: ['rxwebAction',] },],
    'controlConfig': [{ type: core.Input },],
};
var RxwebErrorMessageDirective = /** @class */ (function () {
    /**
     * @param {?} renderer
     * @param {?} elementRef
     */
    function RxwebErrorMessageDirective(renderer, elementRef) {
        this.renderer = renderer;
        this.elementRef = elementRef;
        this.showValidMarkOnControl = false;
        this.bindingErrorMessage = true;
        this.element = this.elementRef.nativeElement;
        this._cssConfig = ReactiveFormConfig.activeUiFramework.cssClasses;
        this.showValidMarkOnControl = ReactiveFormConfig.activeUiFramework.showValidMarkOnControl;
    }
    Object.defineProperty(RxwebErrorMessageDirective.prototype, "errorMessage", {
        /**
         * @param {?} value
         * @return {?}
         */
     ...
     * @return {?}
     */
    RxwebErrorMessageDirective.prototype.isNodeElement = function () {
        var /** @type {?} */ isNodeElement = false;
        switch (this.element.nodeName) {
            case 'TEXTAREA':
            case 'SELECT':
            case 'INPUT':
     ...
     * @return {?}
     */
    RxwebErrorMessageDirective.prototype.getClassName = function (isValid) {
        var /** @type {?} */ className = '';
        switch (this.element.nodeName) {
            case 'TEXTAREA':
            case 'SELECT':
    ...
    return RxwebErrorMessageDirective;
}());
 ...
 * @nocollapse
 */
RxwebErrorMessageDirective.ctorParameters = function () { return [
    { type: core.Renderer, },
    { type: core.ElementRef, },
]; };
RxwebErrorMessageDirective.propDecorators = {
    'formControl': [{ type: core.Input },],
    'errorMessage': [{ type: core.Input, args: ['rxwebError',] },],
};
var RxDynamicReactiveFormsModule = /** @class */ (function () {
    function RxDynamicReactiveFormsModule() {
    }
    /**
     * @return {?}
     */
    RxDynamicReactiveFormsModule.forRoot = function () { return { ngModule: RxDynamicReactiveFormsModule, providers: [] }; };
    return RxDynamicReactiveFormsModule;
}());
 ...
 * @nocollapse
 */
RxDynamicReactiveFormsModule.ctorParameters = function () { return []; };
/**
 * @abstract
 */
var AbstractDynamicControl = /** @class */ (function () {
    function AbstractDynamicControl() {
    }
    /**
     * @return {?}
     */
    AbstractDynamicControl.prototype.ngAfterViewInit = function () {
        var _this = this;
        if (this.rxwebActions && this.rxwebActions.length > 0 && this.controlConfig) {
            this.rxwebActions.forEach(function (rxwebAction) {
                rxwebAction.controlConfig = _this.controlConfig;
            });
        }
    };
    /**
     * @return {?}
     */
    AbstractDynamicControl.prototype.addItem = function () {
     ...
     * @return {?}
     */
    AbstractDynamicControl.prototype.removeItem = function (index) {
        if (this.sectionConfig && this.sectionConfig.controlsConfig && Array.isArray(this.sectionConfig.controlsConfig))
            this.sectionConfig.controlsConfig["removeItem"](index);
    };
    return AbstractDynamicControl;
}());
AbstractDynamicControl.propDecorators = {
    'rxwebActions': [{ type: core.ViewChildren, args: [RxwebActionDirective,] },],
    'formControl': [{ type: core.Input },],
    'formGroup': [{ type: core.Input },],
    'formArray': [{ type: core.Input },],
    'controlConfig': [{ type: core.Input },],
...
var DynamicFormBuilder = /** @class */ (function () {
     ...
     */
    function DynamicFormBuilder(validatorBindings, formConfiguration) {
        this.validatorBindings = validatorBindings;
     ...
     * @return {?}
     */
    DynamicFormBuilder.prototype.dynamicFormGroup = function (fields, formConfiguration) {
        var _this = this;
        ...
        fields.forEach(function (x, i) {
            if (x.type == ARRAY) {
                _this.createFormArray(modelConfig, x, /** @type {?} */ (ApplicationUtil.getRootFormGroup(formGroup)), entityObject);
            }
            else {
                ...
                var /** @type {?} */ modelInstance = _this.getDynamicModelInstance(x, modelConfig, entityObject, name);
     ...
     * @return {?}
     */
    DynamicFormBuilder.prototype.completeModelConfig = function (modelConfig) {
        var _this = this;
        for (var /** @type {?} */ column in modelConfig)
            if (Array.isArray(modelConfig[column]))
                modelConfig[column].forEach(function (x) { return _this.completeModelConfig(x); });
            else {
     ...
     * @return {?}
     */
    DynamicFormBuilder.prototype.createFormArray = function (modelConfig, field, formGroup, entityObject) {
        var _this = this;
        ...
        if (field.controlConfigs) {
            if (field.rows)
                field.rows.forEach(function (row) {
                    formArray.controls.push(_this.createDynamicFormGroup(field, modelConfig[field.name], _this.getRefObject(entityObject[field.name]), row));
                });
     ...
     * @return {?}
     */
    DynamicFormBuilder.prototype.getRefObject = function (entityObject) {
        var /** @type {?} */ jObject = {};
     ...
     * @return {?}
     */
    DynamicFormBuilder.prototype.addTwoProp = function (modelConfig, x, entityObject, formArray) {
        var _this = this;
        modelConfig.__proto__.addItem = function () {
            formArray.controls.push(_this.createDynamicFormGroup(x, modelConfig, _this.getRefObject(entityObject), { fields: [] }));
        };
     ...
     * @return {?}
     */
    DynamicFormBuilder.prototype.createDynamicFormGroup = function (x, modelConfig, entityObject, row) {
        var _this = this;
        ...
        Object.keys(x.controlConfigs).forEach(function (key) {
            ...
            var /** @type {?} */ modelInstance = _this.getDynamicModelInstance(formControlConfig, jObject, entityObject, key);
     ...
     * @return {?}
     */
    DynamicFormBuilder.prototype.getDynamicModelInstance = function (x, modelConfig, entityObject, name) {
        var /** @type {?} */ configModel = (x.modelName) && this.formConfiguration && this.formConfiguration.fieldConfigModels ? this.formConfiguration.fieldConfigModels.filter(function (y) { return y.modelName == x.modelName; })[0] : undefined;
        var /** @type {?} */ modelArguments = [x, modelConfig];
        var /** @type {?} */ model = undefined;
        if ((x.modelName && configModel && !configModel.model) || (x.modelName && (!this.formConfiguration || !this.formConfiguration.fieldConfigModels))) {
            var /** @type {?} */ actionContainer = defaultContainer.getActionContainer(x.modelName);
            if (actionContainer)
        ...
        var /** @type {?} */ modelInstance = getInstance(model, modelArguments);
...
var RxFormBuilder = /** @class */ (function (_super) {
     ...
     * @return {?}
     */
    RxFormBuilder.prototype.dynamicForm = function (fields, formConfiguration) {
        var /** @type {?} */ dynamicFormBuilder = new DynamicFormBuilder(this.additionalValidation, formConfiguration);
...
RxFormControlDirective.propDecorators = {
    ...
    'notEmpty': [{ type: core.Input },],
    'cusip': [{ type: core.Input },],
...
exports.ErrorMessageBindingStrategy = ErrorMessageBindingStrategy;
exports.ResetFormType = ResetFormType;
...
exports.DynamicReactiveFormConfig = DynamicReactiveFormConfig;
exports.RxDynamicReactiveFormsModule = RxDynamicReactiveFormsModule;
exports.AbstractDynamicControl = AbstractDynamicControl;
exports.RxwebActionDirective = RxwebActionDirective;
...
exports.ɵm = FormControlConfig;
exports.ɵk = BaseFormBuilder;
